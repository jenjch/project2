...
$(document).ready( function(){
    ...
    console.log(pCastSearch);
      $.get("/api/searchau/" + pCastSearch, function(data) {
        console.log(data);
    ...
    // id: 20
    // title: "Rocket"
    // image: "http://is5.mzstatic.com/image/thumb/Music71/v4/15/b4/40/15b440b0-1fa5-cb82-fa82-f7174a77e69a/source/600x600bb.jpg(45 kB)
http://is5.mzstatic.com/image/thumb/Music71/v4/15/b4/40/15b440b0-1fa5-cb82-fa82-f7174a77e69a/source/600x600bb.jpg
"
    ...
    // updatedAt: "2020-02-02T12:00:00.000Z"S

Relay FMRelay FM
Rocket - Relay FM
Countdown to excitement! Every week Christina Warren, Brianna Wu and Simone de Rochefort have accelerated geek conversation. Tech, comics, movies, games and books, no galaxy is off limits!(202 kB)
